       ...
       case 'img': {
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                */
                ...
                const base64img = `data:${mimetypes};base64,${mediaData.toString('base64')}`
                const base64imgnobg = await removebg(base64img)
                return client.sendFile(from, base64imgnobg)
                 .then(() => {
                     client.reply(from, 'Here\'s your sticker')
        console.log(`Sticker Processed for ${processTime(t, moment())} Second`)
     })
        ...
        case 'facebook':
            ...
            await client.reply(from, '_Scraping Metadata..._ \n\nTerimakasih telah menggunakan bot ini, kamu dapat membantu pengembangan bot ini dengan menyawer melalui https://saweria.co/donate/mcpr25 \nTerimakasih.', id)
    ...
    break
        ...
        case 'everyone':
            ...
            */
            ...
            await client.sendTextWithMentions(from, `Heyy, ${pushname} Memanggil Mu !!!\n${mentions}`)
            break
        case 'botstat': {
