...
module.exports = msgHandler = async (client = new Client(), message) => {
    try {
        ...
        const ownerNumber = '6283107660652@c.us' // Nomor Owner Bot
        ...
        if (isBlocked) return
        /*await client.sendText(from, (pushname), Frezz)*/
        switch (command) {
